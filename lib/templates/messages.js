//Text
exports.text = (text,params={contextInfo:undefined}) => ({ text, ...params });

//Image
exports.imageBuffer = (image,params={caption:undefined,viewOnce:false}) => ({ image, ...params });
exports.imageUrl = (image, params={caption:undefined,viewOnce:false}) => ({ image: { url: image }, ...params });

//Video
exports.videoBuffer = (video,params={gifPlayback:false}) => ({ video, ...params });
exports.videoUrl = (video,params={gifPlayback:false}) => ({ video: { url: video }, ...params });

//Audio
exports.audioBuffer = (audio,params={mimetype:null, ptt:false}) => ({ audio, ...params});
exports.audioUrl = (audio, params={mimetype:null, ptt:false} ) => ({ audio: { url: audio }, ...params });
